...
if uploaded_person and uploaded_cloth:
    ...
    # Optional: resize while keeping aspect ratio to reasonable max size
    max_height, max_width = 512, 384
    person_img = resize_with_aspect(person_img, max_height, max_width)
    cloth_img = resize_with_aspect(cloth_img, max_height, max_width)
    ...
    # Keep original size (after optional resize)
